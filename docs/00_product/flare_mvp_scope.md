...
After sending a flare, the app should immediately show a recovery response.

The response may include:

- one clear next action
- a brief grounding prompt
- a reminder from Recovery Memory
...
User can create and edit Recovery Memory content.

Recovery Memory should include prompts such as:
...
Recovery Memory setup is optional but strongly encouraged.
...
- Recovery Memory feels meaningful when surfaced
...
- Should Recovery Memory be required before the first flare, or introduced after?
- What is the default recovery response if the user has not configured anything?
